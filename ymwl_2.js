             ...
             */
                ...
                var link = document.createElement('link');
                    link.type='text/css';
                    link.rel = 'stylesheet';
                    link.href ='http://kf.yeyan8.cn/assets/css/index/ymwl_online.css';
                ...
                var blzx ={
                    visiter_id:(typeof ymwl=='undefined' || typeof ymwl.visiter_id == 'undefined')?'':ymwl.visiter_id,
                     ...
                     connenct:function(groupid){
                      var id =groupid;
                      var web =encodeURI('http://kf.yeyan8.cn/layer?theme=7571f9&visiter_id='+blzx.visiter_id+'&visiter_name='+blzx.visiter_name+'&avatar='+blzx.avatar+'&business_id=2&groupid='+groupid+'&product='+blzx.product);
                      
                      var moblieweb = encodeURI('http://kf.yeyan8.cn/mobile/index/home?theme=7571f9&visiter_id='+blzx.visiter_id+'&visiter_name='+blzx.visiter_name+'&avatar='+blzx.avatar+'&business_id=2&groupid='+groupid+'&product='+blzx.product);
