                ...
                var blzx ={
                    visiter_id:(typeof ymwl=='undefined' || typeof ymwl.visiter_id == 'undefined')?'':ymwl.visiter_id,
                     ...
                     connenct:function(groupid){
                      var id =groupid;
                      var web =encodeURI('http://kefu01.zh36.cn/layer?theme=7571f9&visiter_id='+blzx.visiter_id+'&visiter_name='+blzx.visiter_name+'&avatar='+blzx.avatar+'&business_id=3&groupid='+groupid+'&product='+blzx.product);
                      
                      var moblieweb = encodeURI('http://kefu01.zh36.cn/mobile/index/home?theme=7571f9&visiter_id='+blzx.visiter_id+'&visiter_name='+blzx.visiter_name+'&avatar='+blzx.avatar+'&business_id=3&groupid='+groupid+'&product='+blzx.product);
